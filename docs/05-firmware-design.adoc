...
image::https://drive.google.com/file/d/0B5B2OKuFeGQfT3dDRE5RanM3cXM/view?usp=sharing[alt="Code Diagram", link="https://drive.google.com/file/d/0B5B2OKuFeGQfZ0psVGdaODZTZ28/view?usp=sharing", align="center"]
