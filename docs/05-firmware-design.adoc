...
image::https://drive.google.com/file/d/0B5B2OKuFeGQfSWpKemVRNHZqeDg/view?usp=sharing[alt="Code Diagram", link="https://drive.google.com/file/d/0B5B2OKuFeGQfSWpKemVRNHZqeDg/view?usp=sharing", align="center"]
