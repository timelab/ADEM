...
"          document.getElementById('pm1').innerHTML = (json['particulate']['PM1.0'] / 100).toFixed(2);\n"
...
"          document.getElementById('pm1m').innerHTML = (PM10mass(json['particulate']['PM1.0'] - json['particulate']['PM2.5']) + PM25mass(json['particulate']['PM2.5'])).toFixed(2);\n"
